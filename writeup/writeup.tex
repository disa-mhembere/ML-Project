...
learning algorithms that successfully avoided the zero-frequency problem when determing
...
partition to the other. Such algorithms tend to have high misclassification rates.  
