...
\begin{figure}
  \centering
  \subfigure[Title A]{\includegraphics[width=3cm]{img200inv.pdf}}\hfill
  \subfigure[Title B]{\includegraphics[width=3cm]{img800inv.pdf}}\hfill
  \subfigure[Title C]{\includegraphics[width=3cm]{img2000inv.pdf}}\hfill
  \subfigure[Title D]{\includegraphics[width=3cm]{img4000inv.pdf}}\hfill
